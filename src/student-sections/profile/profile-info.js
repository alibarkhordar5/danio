...
export default function ProfileInfo({ profile }) {
  ...
  const defaultValues = useMemo(
    () => ({
      ...
      birth_date: new Date(profile?.personal_info?.birth_date) || null,
    }),
    [profile]
  );
  ...
  return (
    <FormProvider methods={methods} onSubmit={onSubmit}>
      <Card sx={{ p: 3 }}>
        ...
        >
          <RHFTextField name="first_name" label="نام" disabled={!profile.is_individual_customer} />
          <RHFTextField name="last_name" label="نام خانوادگی" disabled={!profile.is_individual_customer} />
          <RHFTextField name="national_code" label="کد ملی" disabled={!profile.is_individual_customer} />
          ...
          <RHFTextField name="school_name" label="نام مدرسه" disabled={!profile.is_individual_customer} />

          <RHFTextField name="province" label="استان" disabled={!profile.is_individual_customer} />
          <RHFTextField name="city" label="شهر" disabled={!profile.is_individual_customer} />
