            ...
            <TableContainer sx={{ overflowX: 'hidden' }}>
                <Scrollbar>
                    <Table>
                        ...
                        <TableBody>
                            {dataInPage.map((row) => (
                                <StudentsTableRow studentPage={studentPage} key={row.id} row={row} />
                            ))}
                        </TableBody>
                    </Table>
                </Scrollbar>
...
function StudentsTableRow({ row, studentPage }) {
    // console.log('row', row);
    return (
        <Link
        ...
        >
            <TableRow>
                ...
                <TableCell align="center">
                    {toFarsiNumber(row.done_homeworks)}
                    از {toFarsiNumber(row.total_homeworks)}
                </TableCell>
                <TableCell align="center">{toFarsiNumber(row.avg_score.toFixed(0))}</TableCell>
